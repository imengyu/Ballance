...
namespace Slua
{
  ...
  {
    const string path = "Assets/System/Scripts/LuaHelpers/LuaDefineApi/";
    ...
    private static void GenNext()
    {
      ...
      EditorUtility.DisplayDialog("完成", "定义文件已经放在 " + path + " 下，推荐使用 VS Code IDE 来编辑你的 Lua 代码，并将定义文件的目录添加到你的编辑器设置中。", "好");
    }
