...
namespace BallancePhysics.Wapper
{
  ...
  public class PhysicsEnvironment : MonoBehaviour
  {
    ...
    [Tooltip("模拟速率（10-100）(模拟开始后更改此值无效)")]
    ...
    private void Awake()
    {
      ...
      else
      {
        ...
        Handle = PhysicsApi.API.create_environment(Gravity, SimulationRate, -2147483647, layerNames.GetGroupFilterMasks());
      }
    }
    private void OnDestroy()
    {
      ...
      {
        foreach(var o in objectsDict)
          o.Value.UnPhysicalize(true);
