...
namespace Ballance2.Sys.Bridge
{
    ...
    public class GameActionStore
    {
        ...
        public int RegisterActions(GamePackage package, string[] names, string[] handlerNames, LuaFunction[] luaFunctionHandlers, LuaTable self, string[][] callTypeChecks)
        {
            ...
            {
                GameErrorChecker.SetLastErrorAndLog(GameError.ParamNotProvide, TAG, "RegisterActions 参数 luaFunctionHandlers 数组为空");
                return succCount;
            }
        ...
        public int RegisterActions(GamePackage package, string[] names, string handlerName, LuaFunction[] luaFunctionHandlers, LuaTable self, string[][] callTypeChecks)
        {
            ...
            if (string.IsNullOrEmpty(handlerName))
            {
                GameErrorChecker.SetLastErrorAndLog(GameError.ParamNotProvide, TAG, "RegisterActions 参数 handlerName 为空");
                return succCount;
            }
            if (CommonUtils.IsArrayNullOrEmpty(luaFunctionHandlers))
            {
