...
namespace Ballance2.System.UI
{
    ...
    public class Window : MonoBehaviour
    {
        ...
        public Sprite Icon
        {
            get { return WindowIconImage.sprite; }
            set { 
                if(value == null)
                {
        ...
        public bool CanResize
        {
            ...
            set { _CanResize = value; SizeDrag.gameObject.SetActive(value); }
        }
        /// <summary>
        /// 窗口是否可以拖动
        /// </summary>
        public bool CanDrag
        {
            get { return WindowTitleDragger.enabled; }
            set { WindowTitleDragger.enabled = value; }
        }
        /// <summary>
        /// 窗口是否可关闭
        /// </summary>
        ...
        {
            get { return WindowButtonClose.gameObject.activeSelf; }
            set { WindowButtonClose.gameObject.SetActive(value);  }
        }
        /// <summary>
        /// 窗口是否可以拖动改变大小
        /// </summary>
            ...
            set
            {
                ...
                if(_CanMax)
                {
                    WindowButtonMinRectTransform.anchoredPosition = 
                        new Vector2(-45, WindowButtonMinRectTransform.anchoredPosition.y);
                }
                else
                {
                    WindowButtonMinRectTransform.anchoredPosition =
                        new Vector2(-27, WindowButtonMinRectTransform.anchoredPosition.y);
                }
            }
        }
        /// <summary>
        ...
        public string Title
        {
            ...
            set { WindowTitleText.text = value; }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public WindowType WindowType { get; internal set; } = WindowType.Normal;
