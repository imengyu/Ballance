    ...
    public class GameLuaObjectHost : MonoBehaviour
    {
        ...
        private bool LuaInit()
        {
            if(GameMod ==  null)
            {
                ...
                {
                    Log.E(TAG + ":" + Name, "LuaObject {0} load error :  LuaModName not provide ", Name);
                ...
                if (GameMod == null)
                {
                    Log.E(TAG + ":" + Name, "LuaObject {0} load error :  LuaModName not found : {1}", Name, LuaModName);
                ...
                if(LuaState == null)
                {
                    Log.E(TAG + ":" + Name, "LuaObject {0} load error :  Mod can not run : {1}", Name, LuaModName);
