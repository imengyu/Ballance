...
function PE_Balloon:Active()
  ...
  self.BallTiggerActived = false
  self.PE_Balloon_Platform.gameObject:SetActive(true)
  self.PE_Balloon_BoxSlide.gameObject:SetActive(true)
  self.PE_Balloon_Ballon04.gameObject:SetActive(true)
  self.PE_Balloon_Ballon03.gameObject:SetActive(true)
  self.PE_Balloon_Ballon02.gameObject:SetActive(true)
  self.PE_Balloon_Ballon01.gameObject:SetActive(true)
  self.PE_Balloon_Ballon_Seil04.gameObject:SetActive(true)
  self.PE_Balloon_Ballon_Seil03.gameObject:SetActive(true)
  self.PE_Balloon_Ballon_Seil02.gameObject:SetActive(true)
  self.PE_Balloon_Ballon_Seil01.gameObject:SetActive(true)
  self.PE_Balloon_Platte00.gameObject:SetActive(true)
  self.PE_Balloon_Platte01.gameObject:SetActive(true)
  self.PE_Balloon_Platte02.gameObject:SetActive(true)
  self.PE_Balloon_Platte03.gameObject:SetActive(true)
  self.PE_Balloon_Platte04.gameObject:SetActive(true)
  self.PE_Balloon_Platte05.gameObject:SetActive(true)
  self.PE_Balloon_Platte06.gameObject:SetActive(true)
  self.PE_Balloon_Platte07.gameObject:SetActive(true)
