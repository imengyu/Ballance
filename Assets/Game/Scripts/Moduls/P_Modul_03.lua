...
function P_Modul_03:Active()
  ...
  self.P_Modul_03_Floor.gameObject:SetActive(true)
  self.P_Modul_03_Gate.gameObject:SetActive(true)
  self.P_Modul_03_Wall01.gameObject:SetActive(true)
  self.P_Modul_03_Wall02.gameObject:SetActive(true)
  self.P_Modul_03_Wall03.gameObject:SetActive(true)
  self.P_Modul_03_Wall04.gameObject:SetActive(true)
  self.P_Modul_03_Wall05.gameObject:SetActive(true)
  self.P_Modul_03_Wall06.gameObject:SetActive(true)
  self.P_Modul_03_Wall07.gameObject:SetActive(true)
