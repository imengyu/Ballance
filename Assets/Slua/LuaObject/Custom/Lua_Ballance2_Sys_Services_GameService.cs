...
public class Lua_Ballance2_Sys_Services_GameService : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.Sys.Services.GameService o;
			System.String a1;
			checkType(l,2,out a1);
			o=new Ballance2.Sys.Services.GameService(a1);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(Ballance2.Sys.Services.GameService));
	}
}
