...
public class Lua_Ballance2_Game_LevelAssets : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.Game.LevelAssets o;
			System.String a1;
			checkType(l,2,out a1);
			System.Boolean a2;
			checkType(l,3,out a2);
			o=new Ballance2.Game.LevelAssets(a1,a2);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int GetTextureAsset(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.Game.LevelAssets self=(Ballance2.Game.LevelAssets)checkSelf(l);
			System.String a1;
			checkType(l,2,out a1);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetLevelAsset(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.String a1;
			checkType(l,2,out a1);
			var ret=self.GetLevelAsset<UnityEngine.Object>(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_LoadInEditor(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_LoadInEditor(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.Game.LevelAssets");
		...
		addMember(l,GetLevelAsset);
		addMember(l,"AssetBundle",get_AssetBundle,set_AssetBundle,true);
		addMember(l,"LoadInEditor",get_LoadInEditor,set_LoadInEditor,true);
		addMember(l,"Path",get_Path,set_Path,true);
		createTypeMetatable(l,constructor, typeof(Ballance2.Game.LevelAssets));
	}
}
