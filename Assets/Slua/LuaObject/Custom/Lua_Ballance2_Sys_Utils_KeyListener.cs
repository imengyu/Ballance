...
public class Lua_Ballance2_Sys_Utils_KeyListener : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_DisableWhenUIFocused(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			Ballance2.Sys.Utils.KeyListener self=(Ballance2.Sys.Utils.KeyListener)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.DisableWhenUIFocused);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_DisableWhenUIFocused(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Get_s);
		addMember(l,"DisableWhenUIFocused",get_DisableWhenUIFocused,set_DisableWhenUIFocused,true);
