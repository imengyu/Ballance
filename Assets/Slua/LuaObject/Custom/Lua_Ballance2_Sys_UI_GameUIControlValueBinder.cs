...
public class Lua_Ballance2_Sys_UI_GameUIControlValueBinder : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int NotifyUserUpdate(IntPtr l) {
		try {
			#if DEBUG
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_SolveInLua(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_SolveInLua(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_UserUpdateCallbacks(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			Ballance2.Sys.UI.GameUIControlValueBinder self=(Ballance2.Sys.UI.GameUIControlValueBinder)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.UserUpdateCallbacks);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_UserUpdateCallbacks(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			Ballance2.Sys.UI.GameUIControlValueBinder self=(Ballance2.Sys.UI.GameUIControlValueBinder)checkSelf(l);
			System.Collections.Generic.List<Ballance2.Sys.UI.GameUIControlValueBinderUserUpdateCallback> v;
			checkType(l,2,out v);
			self.UserUpdateCallbacks=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_BinderSupplierCallback(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			Ballance2.Sys.UI.GameUIControlValueBinder self=(Ballance2.Sys.UI.GameUIControlValueBinder)checkSelf(l);
			Ballance2.Sys.UI.GameUIControlValueBinderSupplierCallback v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.BinderSupplierCallback=v;
			else if(op==1) self.BinderSupplierCallback+=v;
			else if(op==2) self.BinderSupplierCallback-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
