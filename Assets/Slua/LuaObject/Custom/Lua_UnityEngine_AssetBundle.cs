...
public class Lua_UnityEngine_AssetBundle : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int RecompressAssetBundleAsync_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.String a2;
			checkType(l,2,out a2);
			UnityEngine.BuildCompression a3;
			checkValueType(l,3,out a3);
			System.UInt32 a4;
			checkType(l,4,out a4);
			UnityEngine.ThreadPriority a5;
			a5 = (UnityEngine.ThreadPriority)LuaDLL.luaL_checkinteger(l, 5);
			var ret=UnityEngine.AssetBundle.RecompressAssetBundleAsync(a1,a2,a3,a4,a5);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,RecompressAssetBundleAsync_s);
		addMember(l,"isStreamedSceneAssetBundle",get_isStreamedSceneAssetBundle,null,true);
		createTypeMetatable(l,null, typeof(UnityEngine.AssetBundle),typeof(UnityEngine.Object));
	}
}
