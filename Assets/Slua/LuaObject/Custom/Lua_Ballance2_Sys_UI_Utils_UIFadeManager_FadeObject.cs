...
public class Lua_Ballance2_Sys_UI_Utils_UIFadeManager_FadeObject : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.Sys.UI.Utils.UIFadeManager.FadeObject o;
			o=new Ballance2.Sys.UI.Utils.UIFadeManager.FadeObject();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_fadeType(IntPtr l) {
		try {
			...
			#endif
			Ballance2.Sys.UI.Utils.UIFadeManager.FadeObject self=(Ballance2.Sys.UI.Utils.UIFadeManager.FadeObject)checkSelf(l);
			Ballance2.Sys.UI.Utils.UIFadeManager.FadeType v;
			v = (Ballance2.Sys.UI.Utils.UIFadeManager.FadeType)LuaDLL.luaL_checkinteger(l, 2);
			self.fadeType=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.Sys.UI.Utils.UIFadeManager.FadeObject");
