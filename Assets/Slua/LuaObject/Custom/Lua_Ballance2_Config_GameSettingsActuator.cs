...
public class Lua_Ballance2_Config_GameSettingsActuator : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_ACTION_UPDATE(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,Ballance2.Config.GameSettingsActuator.ACTION_UPDATE);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_ACTION_LOAD(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,Ballance2.Config.GameSettingsActuator.ACTION_LOAD);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
