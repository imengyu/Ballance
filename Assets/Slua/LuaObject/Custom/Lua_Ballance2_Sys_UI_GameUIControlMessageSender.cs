...
public class Lua_Ballance2_Sys_UI_GameUIControlMessageSender : LuaObject {
	...
	static public int NotifyEvent(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.Sys.UI.GameUIControlMessageSender self=(Ballance2.Sys.UI.GameUIControlMessageSender)checkSelf(l);
			System.String a1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.Sys.UI.GameUIControlMessageSender");
		...
		createTypeMetatable(l,null, typeof(Ballance2.Sys.UI.GameUIControlMessageSender),typeof(UnityEngine.MonoBehaviour));
	}
}
