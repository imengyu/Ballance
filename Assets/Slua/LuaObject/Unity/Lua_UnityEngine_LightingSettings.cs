...
public class Lua_UnityEngine_LightingSettings : LuaObject {
	...
	static public int set_lightmapper(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightingSettings.Lightmapper)LuaDLL.luaL_checkinteger(l, 2);
			self.lightmapper=v;
			pushValue(l,true);
			return 1;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_compressLightmaps(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.LightingSettings self=(UnityEngine.LightingSettings)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.compressLightmaps);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_compressLightmaps(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public int set_sampling(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightingSettings.Sampling)LuaDLL.luaL_checkinteger(l, 2);
			self.sampling=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_filteringMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightingSettings.FilterMode)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_denoiserTypeDirect(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightingSettings.DenoiserType)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_filterTypeDirect(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightingSettings.FilterType)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"compressLightmaps",get_compressLightmaps,set_compressLightmaps,true);
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.LightingSettings),typeof(UnityEngine.Object));
	}
}
