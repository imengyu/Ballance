...
public class Lua_UnityEngine_LightProbeProxyVolume : LuaObject {
	...
	static public int set_qualityMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightProbeProxyVolume.QualityMode)LuaDLL.luaL_checkinteger(l, 2);
			self.qualityMode=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_dataFormat(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightProbeProxyVolume.DataFormat)LuaDLL.luaL_checkinteger(l, 2);
			self.dataFormat=v;
			pushValue(l,true);
			return 1;
		}
