...
public class Lua_UnityEngine_GUIStyle : LuaObject {
	...
	static public int Draw(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.Rect),typeof(bool),typeof(bool),typeof(bool),typeof(bool))){
				UnityEngine.GUIStyle self=(UnityEngine.GUIStyle)checkSelf(l);
				UnityEngine.Rect a1;
				checkValueType(l,2,out a1);
				System.Boolean a2;
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.Rect),typeof(UnityEngine.GUIContent),typeof(int),typeof(bool),typeof(bool))){
				UnityEngine.GUIStyle self=(UnityEngine.GUIStyle)checkSelf(l);
				UnityEngine.Rect a1;
				checkValueType(l,2,out a1);
				UnityEngine.GUIContent a2;
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function Draw to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_imagePosition(IntPtr l) {
		try {
			...
			v = (UnityEngine.ImagePosition)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_clipping(IntPtr l) {
		try {
			...
			v = (UnityEngine.TextClipping)LuaDLL.luaL_checkinteger(l, 2);
			self.clipping=v;
			pushValue(l,true);
			return 1;
		}
