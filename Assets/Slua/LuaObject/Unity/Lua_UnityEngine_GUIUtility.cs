...
public class Lua_UnityEngine_GUIUtility : LuaObject {
	...
	static public int GetControlID_s(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				a1 = (UnityEngine.FocusType)LuaDLL.luaL_checkinteger(l, 1);
				...
				a2 = (UnityEngine.FocusType)LuaDLL.luaL_checkinteger(l, 2);
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetControlID to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int AlignRectToDevice_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(argc==1){
				...
				var ret=UnityEngine.GUIUtility.AlignRectToDevice(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				System.Int32 a2;
				System.Int32 a3;
				var ret=UnityEngine.GUIUtility.AlignRectToDevice(a1,out a2,out a3);
				pushValue(l,true);
				pushValue(l,ret);
				pushValue(l,a2);
				pushValue(l,a3);
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function AlignRectToDevice to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GUIToScreenRect_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Rect a1;
			checkValueType(l,1,out a1);
			var ret=UnityEngine.GUIUtility.GUIToScreenRect(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
