...
cp build_android_v7a/libslua.so ../Assets/Plugins/Slua/Android/libs/armeabi-v7a/libslua.so
...
cp build_android_arm64/libslua.so ../Assets/Plugins/Slua/Android/libs/armeabi-arm64/libslua.so
...
cp build_android_x86/libslua.so ../Assets/Plugins/Slua/Android/libs/x86/libslua.so