...
public:
    ...
    Remarks:
        ...
        the usual system: if data has been modified since the last time it was fetched, the chain of inputs is
        walked up until an output parameter is found
