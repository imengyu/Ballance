...
#endif
#ifdef _DEBUG
	MyCKInitCustomPlayer(TRUE);
#else
	MyCKInitCustomPlayer(FALSE);
#endif
...
CKSTRING			CKClassIDToCppClassName(CK_CLASSID cid);
...
{\
	...
	CKClassRegister(#cls1, cls1::m_ClassID,Parent_Class::m_ClassID,cls1::Register,(CKCLASSCREATIONFCT)cls1::CreateInstance,(CKCLASSRELEASEFCT)cls1::ReleaseInstance,cls1::GetClassName,cls1::GetDependencies,cls1::GetDependenciesCount);\
}\
...
{\
	if (cls1::m_ClassID<=0)  cls1::m_ClassID=CKClassGetNewIdentifier();\
	CKClassRegister(#cls1, cls1::m_ClassID,Parent_Class,cls1::Register,(CKCLASSCREATIONFCT)cls1::CreateInstance,(CKCLASSRELEASEFCT)cls1::ReleaseInstance,cls1::GetClassName,cls1::GetDependencies,cls1::GetDependenciesCount);\
}\
...
void		  CKClassRegister(const char* cppClassName, CK_CLASSID Cid,CK_CLASSID Parent_Cid,
